...
package com.audio.steganography.ui.widgets;

import java.awt.Component;

/**
 * Helps to create widget components
 *
 *
 */
public class WidgetFactory {
	 ...
	 * @return
	 */
	public static ImageButton createImageButton(String normalImage, String hoverImage, int left, int top, int width, int height) {
